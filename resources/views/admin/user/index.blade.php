...
@section('title')
Catálogo de Usuarios - Naranjo Plastic | CPTV
@endsection
@section('css')
<!-- Fine Uploader CSS -->
...
@section('content')
<div class="card">
  <div class="card-header"><h4>Usuarios de Sistema</h4></div>
  <div class="card-body">
    <div class="table-responsive">
      <button class=" float-right btn btn-success btn-sm" id="addUser"><a class="fa fa-user-plus"> Usuario</a></button>
...
@section('modal')
    @include('admin.user.modal.addUser')
...
<script src="js/AdministradorJS/usuarios.js"></script>
@endsection
