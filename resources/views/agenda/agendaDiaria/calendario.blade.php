...
@section('title')
  Calendario de Citas - Naranjo Plastic | CPTV
@endsection
...
@section('content')
<div class="card">
  <div class="card-header"><h4>Consulta Agenda </h4></div>
  <div class="card-body">
     <div class="row">
      ...
      <div class="col-sm-12">
        <div class="card">
          <div class="card-header Aqua">
            Calendario  <button class=" float-right btn btn-success btn-sm" id="addCita1"><a class="fa fa-user-plus"> Cita</a></button>
          </div>
          <div class="card-body">

            <div class="card card-primary">
              <div class="card-body fc-content ">
                {!! $calendar->calendar() !!}
              </div>
            </div>
          </div>
     ...
     <div class="col-sm-12">
        <div class="card">
          <div class="card-header Aqua">
            Calendario  <button class=" float-right btn btn-success btn-sm" id="addCita"><a class="fa fa-user-plus"> Cita</a></button>
          </div>
          <div class="card-body">
<div class="col-md-12">
