...
@section('title')
  Productos al Público - Naranjo Plastic | CPTV
@endsection

@section('content')
<div class="card">
  <div class="card-header"><h4>Inventario Productos al Público </h4></div>
  <div class="card-body">
     <div class="row">
      <div class="col-sm-12">
        <div class="card">
...
$(document).ready(function() {
    ...
    $('#inventarioPublico').addClass('active');
...
function tablaSearch(fechaInicia,fechaFina) {
  table =$('#Usertable').DataTable({
      ...
      columns:[
          ...
          {data:'nombre', name:'descripcion'},
          { data:'cantidadDisponible', name:'id'},
          {data:'cantidad', name:'cantidad'},
          {data:'cantidadStock', name:'id'},
