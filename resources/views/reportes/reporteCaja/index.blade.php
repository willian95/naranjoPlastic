...
@section('title')
  Movimientos de Caja - NARANJO PLASTIC | CPTV
@endsection

@section('content')
<div class="card">
  <div class="card-header"><h4>Reporte de Movimientos Caja</h4></div>
  <div class="card-body">
   <div class="row">
    <div class="col-sm-12">
      <div class="card">
        ...
        <div class="card-body">
          ...
          <hr/>
              <div class="table-responsive">
                <table id="cajatable" class="table table-striped  table-sm" style="width:100%">
                  <thead class=" Aqua ">
                    <tr>
                      <th>Id</th>
                      <th>Cajero</th>
...
<script src="js/ReportesJS/reporteGeneral.js"></script>
@endsection
