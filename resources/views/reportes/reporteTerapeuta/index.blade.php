...
@section('title')
  Rendimiento de Terapeuta - NARANJO PLASTIC | CPTV
@endsection

@section('content')
<div class="card">
  <div class="card-header"><h4>Reporte Rendimiento de Terapeutas</h4></div>
  <div class="card-body">
   <div class="row">
    <div class="col-sm-12">
      <div class="card">
...
<script src="js/ReportesJS/reporteTerapeuta.js"></script>
@endsection
